...
TEST(test_div, throw_when_try_div_by_zero_test) {
  // Arrange
  int x = 10;
  int y = 0;
...
TEST(test_div, can_div_correctly_test) {
  // Arrange
  int x = 6;
  int y = 2;
...
TEST(test_div, can_div_correctly_with_remainder_test) {
  // Arrange
  int x = 5;
  int y = 4;
